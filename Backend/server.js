...
io.on('connection', (socket) => {
  ...
  socket.on('joinWorkspace', (data) => {
    ...
    console.log(`Workspace join requested for client ${clientId} to workspace ${workspaceId}`);
    ...
    console.log(`Client ${clientId} successfully joined workspace ${workspaceId} (Socket ID: ${socket.id})`);
